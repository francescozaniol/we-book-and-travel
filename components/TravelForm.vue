    ...
    <UCard :ui="{ ring: '', divide: 'divide-y divide-gray-100 dark:divide-gray-800' }">
      <div class="space-y-3">
        ...
        <div>
          ...
          <UInput size="lg" id="editedTravel.title" class="w-full" type="text" name="editedTravel.title" v-model="editedTravel.title" />
        </div>

        <div>
          <label for="editedTravel.description">Description</label>
          <UInput size="lg" id="editedTravel.description" class="w-full" type="text" name="editedTravel.description" v-model="editedTravel.description" />
        </div>

        <div>
          <label for="editedTravel.ratings">Ratings</label>
          <USelect size="lg" id="editedTravel.ratings" class="w-full" name="editedTravel.ratings" v-model="editedTravel.rating"
            :options="[
              { 'value': 0.5, name: '0,5' },
              { 'value': 1, name: '1' },
              { 'value': 1.5, name: '1,5' },
        ...
        <div>
          ...
          <UInput size="lg" type="number" id="editedTravel.price" class="w-full" name="editedTravel.dates.departure" v-model="editedTravel.price" />
        </div>

        <div>
          <label for="editedTravel.dates.departure">Departure date</label>
          <UInput size="lg" type="date" id="editedTravel.dates.departure" class="w-full" name="editedTravel.dates.departure" v-model="editedTravel.dates.departure" />
        </div>

        <div>
          <label for="editedTravel.dates.return">Return date</label>
          <UInput size="lg" type="date" id="editedTravel.dates.return" class="w-full" name="editedTravel.dates.return" v-model="editedTravel.dates.return" />
        </div>

        <div>
          <label for="editedTravel.img.src">Image URL</label>
          <UInput size="lg" type="url" id="editedTravel.img.src" class="w-full" name="editedTravel.img.src" v-model="editedTravel.img.src" />
        </div>
